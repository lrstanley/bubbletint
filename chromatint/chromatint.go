...
func StyleEntry(t *tint.Tint, setBg bool) chroma.StyleEntries {
	...
	return chroma.StyleEntries{ //nolint:exhaustive
		...
		chroma.Keyword:                  compat(&StaticStyle{Fg: adapt(darken(t.BrightPurple, 0.3), lighten(t.BrightPurple, 0.2))}),
		chroma.KeywordConstant:          compat(&StaticStyle{Fg: adapt(darken(t.BrightPurple, 0.3), lighten(t.BrightPurple, 0.2))}),
		chroma.KeywordDeclaration:       compat(&StaticStyle{Fg: t.Cyan, Italic: true}),
		chroma.KeywordNamespace:         compat(&StaticStyle{Fg: adapt(darken(t.BrightPurple, 0.3), lighten(t.BrightPurple, 0.2))}),
		chroma.KeywordPseudo:            compat(&StaticStyle{Fg: adapt(darken(t.BrightPurple, 0.3), lighten(t.BrightPurple, 0.2))}),
		chroma.KeywordReserved:          compat(&StaticStyle{Fg: adapt(darken(t.BrightPurple, 0.3), lighten(t.BrightPurple, 0.2))}),
		...
		chroma.NameTag:                  compat(&StaticStyle{Fg: adapt(darken(t.BrightPurple, 0.3), lighten(t.BrightPurple, 0.2))}),
		...
		chroma.LiteralNumber:            compat(&StaticStyle{Fg: adapt(darken(t.Purple, 0.3), lighten(t.Purple, 0.4))}),
		chroma.LiteralNumberBin:         compat(&StaticStyle{Fg: adapt(darken(t.Purple, 0.3), lighten(t.Purple, 0.4))}),
		chroma.LiteralNumberFloat:       compat(&StaticStyle{Fg: adapt(darken(t.Purple, 0.3), lighten(t.Purple, 0.4))}),
		chroma.LiteralNumberHex:         compat(&StaticStyle{Fg: adapt(darken(t.Purple, 0.3), lighten(t.Purple, 0.4))}),
		chroma.LiteralNumberInteger:     compat(&StaticStyle{Fg: adapt(darken(t.Purple, 0.3), lighten(t.Purple, 0.4))}),
		chroma.LiteralNumberIntegerLong: compat(&StaticStyle{Fg: adapt(darken(t.Purple, 0.3), lighten(t.Purple, 0.4))}),
		chroma.LiteralNumberOct:         compat(&StaticStyle{Fg: adapt(darken(t.Purple, 0.3), lighten(t.Purple, 0.4))}),
		chroma.Operator:                 compat(&StaticStyle{Fg: adapt(darken(t.BrightPurple, 0.3), lighten(t.BrightPurple, 0.2))}),
		chroma.OperatorWord:             compat(&StaticStyle{Fg: adapt(darken(t.BrightPurple, 0.3), lighten(t.BrightPurple, 0.2))}),
		chroma.Punctuation:              compat(&StaticStyle{Fg: t.BrightWhite}),
		chroma.Comment:                  compat(&StaticStyle{Fg: adapt(darken(t.Purple, 0.3), lighten(t.Purple, 0.4)), Faint: true}),
		chroma.CommentHashbang:          compat(&StaticStyle{Fg: adapt(darken(t.Purple, 0.3), lighten(t.Purple, 0.4)), Faint: true}),
		chroma.CommentMultiline:         compat(&StaticStyle{Fg: adapt(darken(t.Purple, 0.3), lighten(t.Purple, 0.4)), Faint: true}),
		chroma.CommentSingle:            compat(&StaticStyle{Fg: adapt(darken(t.Purple, 0.3), lighten(t.Purple, 0.4)), Faint: true}),
		chroma.CommentSpecial:           compat(&StaticStyle{Fg: adapt(darken(t.Purple, 0.3), lighten(t.Purple, 0.4)), Faint: true}),
		chroma.CommentPreproc:           compat(&StaticStyle{Fg: adapt(darken(t.BrightPurple, 0.3), lighten(t.BrightPurple, 0.2))}),
